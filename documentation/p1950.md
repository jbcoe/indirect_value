...
Like `polymorphic_value`, `indirect_value` confers value-like semantics on a free-store allocated object. Unlike `polymorphic_value`,
...
* Returns: A `indirect_value<T>` owning an object of type `T`
