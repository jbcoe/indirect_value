...
requirement for const-propagation and compiler-generated copy constructors but incurs an additional cost in supporting polymorphism.
To implement deep copies of subclasses, `polymorphic_value` employs type-erasure which has run-time cost through
